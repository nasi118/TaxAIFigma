...
.tp-root{--ink:#16202E;--ink-2:#2C3A4C;--paper:#F6F7F9;--line:#E3E6EB;--green:#0E7C66;--green-bg:#E7F1EE;--claret:#A3283B;--blue:#1D4ED8;--gold:#C9A24B;--muted:#7C8794;
  font-family:var(--font-sans);color:var(--color-navy);background:var(--color-ivory-100);min-height:100vh;font-feature-settings:"tnum" 1;}
.tp-root *{box-sizing:border-box;}
/* Shell: sidebar + main */
.tp-shell{display:grid;grid-template-columns:250px 1fr;min-height:100vh;align-items:start;}
.tp-side{position:sticky;top:0;height:100vh;background:var(--color-navy);color:#fff;display:flex;flex-direction:column;gap:18px;padding:20px 16px;overflow-y:auto;}
.tp-brand{display:flex;align-items:center;gap:12px;}
.tp-mark{width:38px;height:38px;border:1.5px solid rgba(255,255,255,.35);border-radius:9px;display:grid;place-items:center;font-family:var(--font-display);font-size:22px;color:var(--color-gold-400);flex-shrink:0;}
.tp-brand h1{font-family:var(--font-display);font-weight:500;font-size:19px;margin:0;letter-spacing:.2px;}
...
.tp-navitem.on{background:var(--color-status-active);color:#fff;font-weight:600;}
...
.tp-btn.ghost.sm{padding:6px 10px;font-size:12px;color:var(--color-navy-700);border-color:var(--color-border);}
.tp-btn.ghost.sm:hover{background:var(--color-ivory-100);color:var(--color-navy);}
.tp-btn.solid{background:var(--color-navy);color:#fff;padding:9px 18px;}
.tp-btn.solid:hover{background:var(--color-navy-700);}
...
.tp-side-stat strong.green{color:#5FD4B6;font-family:var(--font-display);font-size:17px;font-weight:500;}
.tp-main{padding:26px 30px;max-width:1180px;min-width:0;}
.tp-topbar{margin-bottom:20px;}
.tp-topbar h2{font-family:var(--font-display);font-weight:600;font-size:24px;margin:0;color:var(--color-navy);}
.tp-topbar p{margin:5px 0 0;font-size:12.5px;color:var(--color-slate-500);max-width:720px;line-height:1.5;}
/* Summary page */
.tp-summary{display:flex;flex-direction:column;gap:18px;}
.tp-selector{display:flex;align-items:flex-end;gap:14px;flex-wrap:wrap;background:#fff;border:1px solid var(--color-border);border-radius:12px;padding:14px 16px;}
.tp-sel{display:flex;flex-direction:column;gap:4px;}
.tp-sel span{font-size:10px;text-transform:uppercase;letter-spacing:.5px;color:var(--color-slate-500);font-weight:600;}
.tp-sel select{border:1px solid var(--color-border);border-radius:8px;padding:8px 11px;font-size:13px;font-family:inherit;background:#fff;color:var(--color-navy);min-width:200px;}
.tp-sel select:focus{outline:none;border-color:var(--blue);}
.tp-toggle{display:flex;align-items:center;gap:7px;font-size:12.5px;font-weight:500;color:var(--color-navy-700);cursor:pointer;padding-bottom:9px;}
.tp-toggle input{width:15px;height:15px;accent-color:var(--color-status-active);}
.tp-toggle.on{color:var(--color-status-active);font-weight:600;}
.tp-cmpbanner{background:var(--color-navy);color:#fff;border-radius:10px;padding:12px 16px;font-size:13px;line-height:1.5;}
.tp-cmpbanner strong{color:var(--color-gold-400);}
.tp-cmpbanner .save{color:#5FD4B6;font-weight:700;}
.tp-cmpbanner .cost{color:#F09AA6;font-weight:700;}
.tp-sumtbl tr.sec td{background:var(--color-ivory-100);font-size:10.5px;text-transform:uppercase;letter-spacing:.4px;font-weight:700;color:var(--color-navy-700);text-align:left;}
.tp-sumtbl td.ind{padding-left:26px;}
.tp-rownote{display:block;font-style:normal;font-size:10.5px;color:var(--color-slate-500);margin-top:2px;}
.tp-splitgrid{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:14px;padding-top:14px;border-top:1px solid var(--color-border);}
.tp-minihead{font-size:10.5px;text-transform:uppercase;letter-spacing:.5px;font-weight:700;color:var(--color-slate-500);margin-bottom:8px;}
.tp-miniline{display:flex;justify-content:space-between;gap:12px;font-size:12.5px;color:var(--color-navy-700);padding:5px 0;border-bottom:1px solid var(--color-border);}
.tp-miniline strong{font-variant-numeric:tabular-nums;color:var(--color-navy);}
.tp-obs{margin:0;padding-left:17px;display:flex;flex-direction:column;gap:7px;}
.tp-obs li{font-size:12px;line-height:1.5;color:var(--color-navy-700);}
...
.tp-kpi{background:#fff;border:1px solid var(--color-border);border-radius:12px;padding:15px 16px;display:flex;flex-direction:column;gap:4px;}
.tp-kpi>span{font-size:10px;text-transform:uppercase;letter-spacing:.5px;color:var(--color-slate-500);font-weight:600;}
.tp-kpi strong{font-family:var(--font-display);font-size:25px;font-weight:500;line-height:1.1;color:var(--color-navy);}
.tp-kpi strong.sm{font-size:17px;}
.tp-kpi em{font-style:normal;font-size:11px;color:var(--color-slate-500);}
.tp-kpi.good{border-color:var(--color-status-active);}
.tp-kpi.good strong{color:var(--color-status-active);}
.tp-kpi.warn{border-color:var(--color-gold-400);}
.tp-kpi.warn strong{color:#9A7616;}
.tp-card{background:#fff;border:1px solid var(--color-border);border-radius:14px;padding:20px 22px;}
.tp-card-head{display:flex;align-items:baseline;justify-content:space-between;gap:12px;flex-wrap:wrap;margin-bottom:14px;}
.tp-card-head h3{font-family:var(--font-display);font-weight:600;font-size:17px;margin:0;color:var(--color-navy);}
.tp-card-sub{font-size:11.5px;color:var(--color-slate-500);}
.tp-card-note{font-size:12px;color:var(--color-navy-700);line-height:1.6;margin:12px 0 0;padding-top:12px;border-top:1px solid var(--color-border);}
.tp-tblwrap{overflow-x:auto;}
.tp-sumtbl{width:100%;border-collapse:collapse;font-size:12.5px;}
.tp-sumtbl th,.tp-sumtbl td{padding:9px 12px;text-align:right;border-bottom:1px solid var(--color-border);font-variant-numeric:tabular-nums;white-space:nowrap;}
.tp-sumtbl th:first-child,.tp-sumtbl td:first-child{text-align:left;}
.tp-sumtbl th{font-size:10.5px;text-transform:uppercase;letter-spacing:.4px;color:var(--color-slate-500);font-weight:600;}
.tp-sumtbl td.strong{font-weight:700;color:var(--color-navy);}
.tp-sumtbl tr.best{background:var(--color-status-active-bg);}
.tp-sumtbl tr.best td:first-child{font-weight:700;color:var(--color-status-active);}
.tp-sumtbl tr.best td:first-child svg{vertical-align:-2px;margin-right:4px;}
.tp-sumtbl tr.muted td{color:var(--color-slate-500);}
.tp-sumtbl tr.tot td{border-top:2px solid var(--color-navy);border-bottom:none;font-weight:700;background:#FAFBFC;}
.tp-sumtbl td.save{color:var(--color-status-active);font-weight:600;}
.tp-sumtbl td.cost{color:var(--color-risk-high);font-weight:600;}
.tp-sumtbl th.wide,.tp-sumtbl td.wide{text-align:left;white-space:normal;min-width:250px;}
.tp-sumtbl td.note{font-size:11px;color:var(--color-slate-500);line-height:1.45;}
...
.tp-bar i{display:block;height:100%;background:var(--color-navy-700);}
/* Findings */
.tp-clean{display:flex;align-items:center;gap:10px;padding:16px;background:var(--color-status-active-bg);border-radius:10px;color:var(--color-status-active);font-size:13px;font-weight:500;}
.tp-findings{display:flex;flex-direction:column;gap:10px;}
.tp-finding{display:flex;gap:12px;border:1px solid var(--color-border);border-radius:11px;padding:13px 15px;background:#FBFCFD;}
.tp-finding.quant{border-left:3px solid var(--color-status-active);}
.tp-finding.flag{border-left:3px solid var(--color-gold-400);}
.tp-finding-rank{width:24px;height:24px;border-radius:50%;display:grid;place-items:center;font-size:11.5px;font-weight:700;flex-shrink:0;background:var(--color-navy);color:#fff;}
...
.tp-finding-title{font-size:13.5px;font-weight:700;color:var(--color-navy);line-height:1.35;}
.tp-finding-tags{display:flex;align-items:center;gap:6px;flex-wrap:wrap;}
.tp-tag2{font-size:9.5px;text-transform:uppercase;letter-spacing:.4px;font-weight:600;color:var(--color-slate-500);background:#EDF0F3;padding:3px 7px;border-radius:4px;}
.tp-save{font-size:11.5px;font-weight:700;color:#fff;background:var(--color-status-active);padding:3px 9px;border-radius:20px;white-space:nowrap;}
.tp-save.neutral{background:#EDF0F3;color:var(--color-slate-500);}
.tp-finding-why{font-size:12px;color:var(--color-navy-700);line-height:1.55;margin-top:7px;}
.tp-finding-act{display:flex;align-items:flex-start;gap:6px;font-size:12px;color:var(--color-status-active);line-height:1.5;margin-top:7px;font-weight:500;}
.tp-finding-act svg{flex-shrink:0;margin-top:2px;}
.tp-finding-ref{font-size:10.5px;color:var(--color-slate-500);font-style:italic;margin-top:6px;}
.tp-recs{margin:0;padding-left:20px;display:flex;flex-direction:column;gap:10px;}
.tp-recs li{font-size:12.5px;line-height:1.6;color:var(--color-navy-700);}
.tp-recs strong{color:var(--color-navy);}
...
.tp-vcard{background:#fff;border:1px solid var(--color-border);border-radius:12px;padding:16px 16px 14px;position:relative;overflow:hidden;}
.tp-vcard.best{border-color:var(--color-status-active);box-shadow:0 0 0 1px var(--color-status-active);}
.tp-badge{position:absolute;top:0;right:0;background:var(--color-status-active);color:#fff;font-size:9.5px;font-weight:600;letter-spacing:.4px;text-transform:uppercase;padding:3px 9px;border-radius:0 11px 0 9px;display:flex;align-items:center;gap:3px;}
.tp-vname{font-size:12px;color:var(--color-slate-500);font-weight:500;margin-bottom:6px;max-width:85%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
.tp-vtotal{font-family:var(--font-display);font-size:27px;font-weight:500;line-height:1;}
.tp-vsub{font-size:11px;color:var(--color-slate-500);margin-top:5px;}
.tp-vdelta{font-size:12px;font-weight:500;margin-top:9px;display:flex;align-items:center;gap:4px;}
.tp-vdelta.save{color:var(--color-status-active);}.tp-vdelta.cost{color:var(--color-risk-high);}
.tp-vdelta.base,.tp-vdelta:not(.save):not(.cost){color:var(--color-slate-500);}
.tp-ledger-wrap{background:#fff;border:1px solid var(--color-border);border-radius:14px;overflow:hidden;margin-bottom:22px;}
.tp-ledger{display:grid;overflow-x:auto;}
.tp-cell{padding:8px 12px;font-size:13px;border-bottom:1px solid var(--color-border);display:flex;align-items:center;min-width:0;}
.tp-corner{background:var(--color-navy);color:#fff;font-weight:600;font-size:11px;text-transform:uppercase;letter-spacing:.6px;position:sticky;left:0;z-index:5;}
.tp-schead{background:var(--color-navy);color:#fff;justify-content:space-between;gap:6px;}
...
.tp-group{background:var(--color-ivory-100);font-family:var(--font-display);font-weight:600;font-size:14px;color:var(--color-navy);cursor:pointer;user-select:none;gap:6px;position:sticky;left:0;}
.tp-group.tax{color:#fff;background:var(--color-navy-700);cursor:default;}
.tp-label{color:var(--color-navy-700);position:sticky;left:0;background:#fff;z-index:2;}
.tp-label.muted{color:var(--color-slate-500);font-size:12px;}
.tp-label.indent{padding-left:26px;color:var(--color-slate-500);font-style:italic;}
.tp-label.calc{font-weight:600;}
.tp-label.drill{flex-direction:column;align-items:flex-start;justify-content:center;gap:0;}
.tp-label.drill span{font-weight:500;color:var(--color-navy);}
.tp-label.drill em{font-size:10.5px;font-style:normal;color:var(--color-slate-500);}
.tp-input{padding:0;}
...
.tp-calc.muted{color:var(--color-slate-500);font-size:12px;}
button.tp-calc.drill{background:#FBFCFD;border:none;border-bottom:1px solid var(--color-border);cursor:pointer;font-family:inherit;font-size:13px;color:var(--color-navy);font-weight:500;position:relative;transition:background .12s;}
button.tp-calc.drill:hover{background:var(--color-status-active-bg);color:var(--color-status-active);}
.tp-drill-ico{opacity:.35;flex-shrink:0;}
button.tp-calc.drill:hover .tp-drill-ico{opacity:.9;}
.tp-calc select.tp-mini-select{width:100%;font-size:11.5px;padding:4px 6px;border:1px solid var(--color-border);border-radius:6px;font-family:inherit;color:var(--color-navy-700);background:#fff;}
...
.tp-calc.grand{font-weight:700;font-size:15px;background:var(--color-navy);color:#fff;font-family:var(--font-display);}
.tp-label.grand{font-weight:700;background:var(--color-navy);color:#fff;font-family:var(--font-display);}
.tp-calc.aftertax{font-weight:700;color:var(--color-status-active);background:var(--color-status-active-bg);}
.tp-label.aftertax{font-weight:700;color:var(--color-status-active);background:var(--color-status-active-bg);}
.tp-calc.rate{color:var(--color-navy-700);font-weight:600;}.tp-label.rate{color:var(--color-navy-700);}
.tp-tag{font-size:9px;text-transform:uppercase;letter-spacing:.4px;font-weight:600;color:var(--color-slate-500);background:#EDF0F3;padding:2px 5px;border-radius:4px;}
.tp-panel{background:#fff;border:1px solid var(--color-border);border-radius:14px;padding:20px 22px 16px;margin-bottom:22px;}
.tp-panel-head{display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;margin-bottom:8px;}
.tp-panel-head h2{font-family:var(--font-display);font-weight:500;font-size:17px;margin:0;}
.tp-legend{display:flex;align-items:center;gap:12px;font-size:11.5px;color:var(--color-slate-500);}
...
.tp-notes{background:#fff;border:1px solid var(--color-border);border-radius:14px;padding:20px 22px;}
.tp-notes-head{display:flex;align-items:center;gap:8px;font-family:var(--font-display);font-weight:600;font-size:15px;margin-bottom:12px;}
.tp-notes ul{margin:0;padding-left:18px;display:flex;flex-direction:column;gap:9px;}
.tp-notes li{font-size:12.5px;line-height:1.55;color:var(--color-navy-700);}
.tp-notes strong{color:var(--color-navy);font-weight:600;}
...
.tp-modal{background:var(--color-ivory-100);border-radius:16px;width:100%;max-width:780px;box-shadow:0 24px 60px rgba(0,0,0,.3);overflow:hidden;margin:auto;}
.tp-modal-head{background:var(--color-navy);color:#fff;padding:18px 22px;display:flex;align-items:flex-start;justify-content:space-between;gap:14px;}
.tp-modal-eyebrow{font-size:11px;text-transform:uppercase;letter-spacing:.6px;color:var(--color-gold-400);font-weight:600;margin-bottom:3px;}
.tp-modal-head h3{margin:0;font-family:var(--font-display);font-weight:500;font-size:18px;}
...
.tp-modal-foot{padding:14px 22px;background:#fff;border-top:1px solid var(--color-border);display:flex;justify-content:flex-end;}
...
.tp-mfield>span{font-size:11.5px;color:var(--color-navy-700);font-weight:500;display:flex;justify-content:space-between;gap:8px;}
.tp-mfield>span em{font-style:normal;color:var(--color-slate-500);font-size:10.5px;}
.tp-mmoney{border:1px solid var(--color-border);border-radius:8px;padding:9px 11px;font-size:14px;font-family:inherit;color:var(--blue);font-weight:600;text-align:right;background:#fff;font-variant-numeric:tabular-nums;}
.tp-mmoney:focus{outline:none;border-color:var(--blue);box-shadow:0 0 0 3px rgba(29,78,216,.1);}
.tp-mmoney.dim{color:#B7C0CA;}
.tp-sublabel{font-size:11px;text-transform:uppercase;letter-spacing:.6px;font-weight:600;color:var(--color-navy-700);padding-top:6px;border-top:1px solid var(--color-border);display:flex;justify-content:space-between;align-items:baseline;}
.tp-sublabel em{font-style:normal;text-transform:none;letter-spacing:0;font-weight:400;color:var(--color-slate-500);font-size:11px;}
...
.tp-linelabel{border:1px solid var(--color-border);border-radius:8px;padding:8px 10px;font-size:13px;font-family:inherit;background:#fff;}
.tp-linelabel:focus{outline:none;border-color:var(--blue);}
.tp-linedel{background:transparent;border:none;color:var(--color-slate-500);cursor:pointer;display:grid;place-items:center;padding:6px;border-radius:6px;}
.tp-linedel:hover{background:#FCEBED;color:var(--color-risk-high);}
.tp-lineadd{align-self:flex-start;display:inline-flex;align-items:center;gap:5px;background:transparent;border:1px dashed var(--color-border);border-radius:7px;padding:6px 11px;font-size:12px;color:var(--color-navy-700);font-family:inherit;cursor:pointer;}
.tp-lineadd:hover{border-color:var(--color-status-active);color:var(--color-status-active);}
.tp-biz{background:#fff;border:1px solid var(--color-border);border-radius:12px;padding:16px;display:flex;flex-direction:column;gap:12px;}
.tp-biz-head{display:flex;align-items:center;gap:10px;}
.tp-biz-name{flex:1;border:none;border-bottom:1.5px solid var(--color-border);padding:4px 2px;font-size:15px;font-weight:600;font-family:var(--font-display);background:transparent;}
.tp-biz-name:focus{outline:none;border-bottom-color:var(--color-status-active);}
.tp-biz-net{display:flex;justify-content:space-between;align-items:center;padding:10px 12px;background:var(--color-status-active-bg);border-radius:8px;font-size:13px;}
.tp-biz-net strong{font-size:15px;color:var(--color-status-active);}
.tp-biz-net.neg{background:#FCEBED;}
.tp-biz-net.neg strong{color:var(--color-risk-high);}
.tp-add-block{align-self:flex-start;display:inline-flex;align-items:center;gap:6px;background:#fff;border:1px dashed var(--color-border);border-radius:9px;padding:9px 14px;font-size:13px;font-weight:500;color:var(--color-navy-700);font-family:inherit;cursor:pointer;}
.tp-add-block:hover{border-color:var(--color-status-active);color:var(--color-status-active);background:var(--color-status-active-bg);}
.tp-editor-total{display:flex;justify-content:space-between;align-items:center;padding:14px 16px;background:var(--color-navy);color:#fff;border-radius:10px;font-size:13px;font-weight:500;}
.tp-editor-total strong{font-family:var(--font-display);font-size:19px;font-weight:500;}
...
.tp-subtotal-line.muted{background:transparent;color:var(--color-slate-500);font-weight:500;padding:4px 12px;}
.tp-tbl{border:1px solid var(--color-border);border-radius:10px;overflow:hidden;background:#fff;}
.tp-tbl-head{display:grid;background:var(--color-ivory-100);font-size:10.5px;text-transform:uppercase;letter-spacing:.4px;font-weight:600;color:var(--color-slate-500);}
...
.tp-tbl-row{display:grid;border-top:1px solid var(--color-border);align-items:center;}
...
.tp-tbl-row .tp-mmoney{border:none;border-left:1px solid var(--color-border);border-radius:0;padding:8px;font-size:12.5px;}
...
.tp-tbl-calc{padding:8px;text-align:right;font-size:12px;color:var(--color-slate-500);border-left:1px solid var(--color-border);font-variant-numeric:tabular-nums;}
.tp-qbi-controls{display:flex;gap:20px;flex-wrap:wrap;padding:12px 14px;background:#fff;border:1px solid var(--color-border);border-radius:10px;}
.tp-check{display:flex;align-items:center;gap:8px;font-size:12.5px;color:var(--color-navy-700);font-weight:500;cursor:pointer;}
.tp-check input{width:15px;height:15px;accent-color:var(--color-status-active);}
.tp-qbi-summary{display:flex;flex-direction:column;gap:6px;background:#fff;border:1px solid var(--color-border);border-radius:10px;padding:12px 14px;}
.tp-qbi-summary>div{display:flex;justify-content:space-between;font-size:12.5px;color:var(--color-navy-700);}
.tp-qbi-summary .hl{border-top:1px solid var(--color-border);padding-top:8px;margin-top:2px;font-weight:700;color:var(--color-navy);}
.tp-qbi-summary .hl strong{color:var(--color-status-active);font-size:15px;}
.tp-note-inline{font-size:12px;line-height:1.5;color:var(--color-navy-700);background:#FFF8EC;border:1px solid #F0E2C4;border-radius:8px;padding:9px 12px;}
.tp-note-inline.sm{font-size:11px;padding:7px 10px;}
.tp-se-line{display:flex;justify-content:space-between;align-items:baseline;padding:8px 4px;font-size:13px;color:var(--color-navy-700);}
.tp-se-line em{font-style:normal;color:var(--color-slate-500);font-size:11px;margin-left:8px;}
.tp-se-line strong{font-variant-numeric:tabular-nums;color:var(--color-navy);}
.tp-se-line.bold{font-weight:700;color:var(--color-navy);}
.tp-se-line.bold strong{font-size:15px;}
.tp-se-divider{height:1px;background:var(--color-border);margin:2px 0;}
/* Add-scenario row + planning button */
.tp-add-row{display:flex;gap:10px;flex-wrap:wrap;margin:12px;}
.tp-add{display:inline-flex;align-items:center;gap:6px;padding:9px 14px;background:#fff;border:1px dashed var(--color-border);border-radius:8px;color:var(--color-navy-700);font-size:13px;font-weight:500;font-family:inherit;cursor:pointer;}
.tp-add:hover{border-color:var(--color-status-active);color:var(--color-status-active);background:var(--color-status-active-bg);}
.tp-add.planning{border-style:solid;border-color:var(--color-status-active);color:#fff;background:var(--color-status-active);}
...
.tp-planmenu{position:absolute;bottom:calc(100% + 8px);left:0;z-index:30;width:340px;max-width:88vw;background:#fff;border:1px solid var(--color-border);border-radius:12px;box-shadow:0 16px 40px rgba(16,24,34,.18);overflow:hidden;}
.tp-planmenu-head{padding:11px 14px;background:var(--color-ivory-100);font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:var(--color-navy-700);display:flex;justify-content:space-between;align-items:baseline;gap:8px;}
.tp-planmenu-head em{font-style:normal;text-transform:none;letter-spacing:0;font-weight:400;color:var(--color-slate-500);font-size:10.5px;}
.tp-planmenu-item{width:100%;display:flex;gap:10px;align-items:flex-start;padding:11px 14px;background:#fff;border:none;border-top:1px solid var(--color-border);text-align:left;cursor:pointer;font-family:inherit;}
.tp-planmenu-item:hover{background:var(--color-status-active-bg);}
.tp-planmenu-item svg{color:var(--color-status-active);flex-shrink:0;margin-top:1px;}
.tp-planmenu-item span{display:flex;flex-direction:column;gap:2px;font-size:11.5px;color:var(--color-slate-500);line-height:1.45;}
.tp-planmenu-item strong{font-size:13px;color:var(--color-navy);font-weight:600;}
/* Tax Library */
.tp-lib{background:#fff;border:1px solid var(--color-border);border-radius:14px;padding:22px;margin-bottom:22px;}
.tp-lib-controls{display:flex;flex-direction:column;gap:12px;margin:4px 0 14px;}
.tp-lib-search{width:100%;border:1px solid var(--color-border);border-radius:9px;padding:11px 13px;font-size:13.5px;font-family:inherit;background:var(--color-ivory-100);}
...
.tp-chip{border:1px solid var(--color-border);background:#fff;border-radius:20px;padding:6px 13px;font-size:11.5px;font-family:inherit;font-weight:500;color:var(--color-navy-700);cursor:pointer;}
.tp-chip:hover{border-color:var(--color-navy-700);}
.tp-chip.on{background:var(--color-navy);color:#fff;border-color:var(--color-navy);}
.tp-lib-count{font-size:11px;color:var(--color-slate-500);text-transform:uppercase;letter-spacing:.5px;font-weight:600;margin-bottom:10px;}
.tp-lib-list{display:grid;grid-template-columns:repeat(auto-fill,minmax(320px,1fr));gap:12px;}
.tp-lib-card{border:1px solid var(--color-border);border-radius:11px;padding:14px 15px;background:#FBFCFD;}
.tp-lib-top{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;}
.tp-lib-title{font-size:13.5px;font-weight:700;color:var(--color-navy);line-height:1.35;}
.tp-lib-cat{font-size:10px;text-transform:uppercase;letter-spacing:.4px;color:var(--color-slate-500);font-weight:600;margin-top:5px;}
.tp-lib-sum{font-size:12px;color:var(--color-navy-700);line-height:1.55;margin:8px 0 10px;}
.tp-lib-meta{display:flex;flex-direction:column;gap:5px;border-top:1px solid var(--color-border);padding-top:9px;}
.tp-lib-meta>div{font-size:11px;color:var(--color-navy-700);line-height:1.4;}
.tp-lib-meta span{display:inline-block;min-width:66px;color:var(--color-slate-500);font-weight:600;text-transform:uppercase;letter-spacing:.3px;font-size:9.5px;margin-right:6px;vertical-align:1px;}
.tp-lib-empty{grid-column:1/-1;padding:24px;text-align:center;color:var(--color-slate-500);font-size:13px;}
@media (max-width:640px){.tp-lib-list{grid-template-columns:1fr;}}
/* Segmented control */
.tp-seg{display:inline-flex;border:1px solid var(--color-border);border-radius:8px;overflow:hidden;background:#fff;}
.tp-seg button{border:none;background:transparent;padding:7px 13px;font-size:12px;font-family:inherit;font-weight:500;color:var(--color-navy-700);cursor:pointer;border-right:1px solid var(--color-border);}
.tp-seg button:last-child{border-right:none;}
.tp-seg button.on{background:var(--color-navy);color:#fff;}
.tp-planrow{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;}
.tp-planrow>span{font-size:12.5px;color:var(--color-navy-700);font-weight:500;}
.tp-plan-summary{display:flex;flex-direction:column;gap:6px;background:#fff;border:1px solid var(--color-border);border-radius:10px;padding:13px 15px;margin-top:4px;}
.tp-plan-summary>div{display:flex;justify-content:space-between;font-size:12.5px;color:var(--color-navy-700);}
.tp-plan-summary .sub{border-top:1px solid var(--color-border);padding-top:8px;margin-top:2px;font-weight:600;color:var(--color-navy);}
.tp-plan-summary .hl{font-weight:700;color:var(--color-navy);}
.tp-plan-summary .hl strong{color:var(--color-status-active);font-size:15px;}
/* Multi-year projection */
.tp-proj-controls{display:flex;gap:16px;flex-wrap:wrap;}
.tp-proj-controls label{font-size:10px;text-transform:uppercase;letter-spacing:.5px;color:var(--color-slate-500);font-weight:600;display:flex;flex-direction:column;gap:3px;}
.tp-stepper{display:flex;align-items:center;gap:3px;font-size:12px;text-transform:none;letter-spacing:0;color:var(--color-navy-700);font-weight:500;}
.tp-stepper input{width:52px;border:1px solid var(--color-border);border-radius:6px;padding:5px 6px;font-family:inherit;font-size:12.5px;text-align:right;color:var(--blue);font-weight:600;}
.tp-stepper input:focus{outline:none;border-color:var(--blue);}
.tp-proj-hint{font-size:12.5px;color:var(--color-navy-700);line-height:1.55;margin:10px 2px 2px;}
.tp-proj-tblwrap{overflow-x:auto;margin-top:14px;}
.tp-proj-tbl{width:100%;border-collapse:collapse;font-size:12.5px;}
.tp-proj-tbl th,.tp-proj-tbl td{padding:8px 12px;text-align:right;border-bottom:1px solid var(--color-border);font-variant-numeric:tabular-nums;white-space:nowrap;}
.tp-proj-tbl th:first-child,.tp-proj-tbl td:first-child{text-align:left;}
.tp-proj-tbl thead th{font-size:11px;color:var(--color-slate-500);font-weight:600;border-bottom:1.5px solid var(--color-border);}
.tp-dot{display:inline-block;width:9px;height:9px;border-radius:50%;margin-right:6px;vertical-align:middle;}
.tp-proj-cum td{font-weight:700;border-top:2px solid var(--color-navy);border-bottom:none;background:#FAFBFC;}
.tp-proj-cum td:first-child{color:var(--color-navy);}
.tp-proj-best{display:inline-block;margin-left:6px;font-size:9px;text-transform:uppercase;letter-spacing:.4px;font-weight:600;color:#fff;background:var(--color-status-active);padding:2px 6px;border-radius:4px;}
/* Guide */
.tp-guide{background:#fff;border:1px solid var(--color-border);border-radius:14px;padding:22px;margin-bottom:22px;}
.tp-guide-head{margin-bottom:16px;}
.tp-guide-title{display:flex;align-items:center;gap:9px;font-family:var(--font-display);font-weight:600;font-size:19px;color:var(--color-navy);}
.tp-guide-sub{font-size:12.5px;color:var(--color-slate-500);margin-top:6px;line-height:1.5;max-width:760px;}
.tp-law{border:1px solid var(--color-border);border-radius:11px;overflow:hidden;margin-bottom:18px;background:#FBFCFD;}
.tp-law-toggle{width:100%;display:flex;align-items:center;gap:8px;padding:11px 14px;background:transparent;border:none;font-family:inherit;font-size:13px;font-weight:600;color:var(--color-navy);cursor:pointer;}
.tp-law-toggle svg:last-of-type{color:var(--color-status-active);}
.tp-law-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(230px,1fr));gap:10px;padding:0 14px 14px;}
.tp-law-card{background:#fff;border:1px solid var(--color-border);border-radius:9px;padding:11px 12px;position:relative;}
.tp-law-when{position:absolute;top:10px;right:10px;font-size:9px;font-weight:600;letter-spacing:.3px;color:var(--color-status-active);background:var(--color-status-active-bg);padding:2px 6px;border-radius:4px;}
.tp-law-t{font-size:12.5px;font-weight:700;color:var(--color-navy);margin-bottom:4px;padding-right:46px;}
.tp-law-d{font-size:11.5px;color:var(--color-navy-700);line-height:1.5;}
.tp-guide-cats{display:flex;flex-direction:column;gap:8px;}
.tp-cat{border:1px solid var(--color-border);border-radius:11px;overflow:hidden;}
.tp-cat.open{border-color:#D3DAE2;}
.tp-cat-head{width:100%;display:flex;align-items:center;gap:9px;padding:13px 15px;background:var(--color-ivory-100);border:none;font-family:var(--font-display);font-size:15px;font-weight:600;color:var(--color-navy);cursor:pointer;text-align:left;}
.tp-cat-head span{flex:1;}
.tp-cat-head em{font-style:normal;font-family:'Inter';font-size:11px;font-weight:600;color:var(--color-slate-500);background:#fff;border:1px solid var(--color-border);border-radius:20px;padding:2px 9px;}
.tp-cat-body{padding:6px 15px 15px;display:flex;flex-direction:column;gap:10px;}
.tp-consid{border-left:2.5px solid var(--color-border);padding:2px 0 2px 14px;}
.tp-consid-top{display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;}
.tp-consid-name{font-size:13.5px;font-weight:600;color:var(--color-navy);}
...
.tp-risk.low{color:var(--color-status-active);background:var(--color-status-active-bg);}
.tp-risk.med{color:#8A6D1A;background:#FBF3DD;}
.tp-risk.high{color:var(--color-risk-high);background:#FBEAEC;}
.tp-consid-b{font-size:12.5px;color:var(--color-navy-700);line-height:1.55;margin-top:5px;}
.tp-consid-meta{font-size:11px;color:var(--color-slate-500);margin-top:5px;font-style:italic;}
.tp-disclaimer{margin-top:16px;padding:14px 16px;background:#FBFCFD;border:1px solid var(--color-border);border-radius:10px;font-size:11.5px;line-height:1.6;color:var(--color-slate-500);}
.tp-disclaimer strong{color:var(--color-navy-700);}
